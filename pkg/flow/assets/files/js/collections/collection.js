...
class Collection {
    ...
    attributes(view, event, x, y) {
        this.object.$type = view.model.attributes.element;
        this.object.attributesForm();
        waitForEl('.' + this.object.$className, function() {this.object.attributes(view, event, x, y)}.bind(this));
    }
